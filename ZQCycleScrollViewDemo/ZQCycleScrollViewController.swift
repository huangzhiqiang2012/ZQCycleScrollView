...
class ZQCycleScrollViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        contentConfig.style = .imageAndTitle
        ...
        cycleScrollView.didScrollOperationClosure = {(index) in
            print("--__--|| closure_didScrollToIndex__\(index)")
        }
        cycleScrollView.didSelectOperationClosure = {(index) in
            print("--__--|| closure_didSelectItemAtIndex__\(index)")
        }
        view.addSubview(cycleScrollView)
    }
}

// MARK: ZQCycleScrollViewDelegate
extension ZQCycleScrollViewController : ZQCycleScrollViewDelegate {
    func cycleScrollView(cycleScrollView: ZQCycleScrollView, didScrollToIndex index: Int) {
        print("--__--|| didScrollToIndex__\(index)")
    }
    
    func cycleScrollView(cycleScrollView: ZQCycleScrollView, didSelectItemAtIndex index: Int) {
        print("--__--|| didSelectItemAtIndex__\(index)")
    }
}
